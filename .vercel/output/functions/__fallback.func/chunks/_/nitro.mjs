...
const _lazy_RvNijS = () => import('../routes/api/admin/info.get.mjs');
const _lazy_fB22kp = () => import('../routes/api/auth/login.post.mjs');
const _lazy_9eIvpL = () => import('../routes/api/index.get.mjs');
const _lazy_nY5Wfk = () => import('../routes/api/index.post.mjs');
const _lazy_NtyuzS = () => import('../routes/api/consulta-cnpj.post.mjs');
const _lazy_7xDu_D = () => import('../routes/api/dashboard/aniversariantes.get.mjs');
const _lazy_8oPbxc = () => import('../routes/api/dashboard/stats.get.mjs');
const _lazy_L3UuSM = () => import('../routes/api/debug/variaveis.get.mjs');
const _lazy_1DtCMI = () => import('../routes/api/departamentos/criar.post.mjs');
const _lazy_tCJ0A4 = () => import('../routes/api/index.get2.mjs');
const _lazy_KMloXw = () => import('../routes/api/empresas/_id_.delete.mjs');
const _lazy_33ZwuU = () => import('../routes/api/empresas/_id_.get.mjs');
const _lazy_5w3hsm = () => import('../routes/api/index.get3.mjs');
const _lazy_B_99Tp = () => import('../routes/api/index.post2.mjs');
const _lazy_jj_cE5 = () => import('../routes/api/empresas/schema.get.mjs');
const _lazy_kJUAG4 = () => import('../routes/api/funcionarios/_id_.get.mjs');
const _lazy_t2mixh = () => import('../routes/api/funcionarios/_id_.patch.mjs');
const _lazy_2jvpyD = () => import('../routes/api/funcionarios/enviar-acesso.post.mjs');
const _lazy_YJnlrW = () => import('../routes/api/index.get4.mjs');
...
const _lazy_UtNzfp = () => import('../routes/api/holerites/_id/html.get.mjs');
const _lazy_kdRlfP = () => import('../routes/api/holerites/_id/pdf.get.mjs');
const _lazy_hj9TvC = () => import('../routes/api/holerites/gerar.post.mjs');
const _lazy_3CRJ8g = () => import('../routes/api/index.get5.mjs');
const _lazy_eg4t6r = () => import('../routes/api/holerites/itens-personalizados/_funcionarioId_.get.mjs');
const _lazy_pIK1nE = () => import('../routes/api/holerites/itens-personalizados/_id_.delete.mjs');
const _lazy_zaitAP = () => import('../routes/api/holerites/index.post.mjs');
const _lazy_p3EyA5 = () => import('../routes/api/holerites/meus-holerites.get.mjs');
const _lazy_UGXuYg = () => import('../routes/api/jornadas/_id_.get.mjs');
const _lazy_TzKUtQ = () => import('../routes/api/index.get6.mjs');
const _lazy_77dzEn = () => import('../routes/api/index.post4.mjs');
const _lazy_wsWlnR = () => import('../routes/api/test-supabase.get.mjs');
const _lazy_r5EtnN = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
